  ...
  return (
    <div className="min-h-screen text-[#e1e2eb] selection:bg-[#b8c3ff]/30" style={{ background: "#0b0e14", backgroundImage: "radial-gradient(circle at 50% -20%, #2a3f95 0%, transparent 40%)" }}>
      ...
      <nav className="fixed top-0 w-full z-50 backdrop-blur-xl border-b border-white/5 px-8 py-4" style={{ background: "rgba(16,19,26,0.7)" }}>
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <span className="font-sans text-xl font-bold text-white tracking-tight">Quintal AI</span>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/login" className="bg-[#b8c3ff] hover:bg-[#6d88ff] text-[#002388] px-6 py-2 rounded-lg font-sans font-semibold text-sm transition-all active:scale-95">
              Sign In
            </Link>
          </div>
        </div>
      ...
      <section className="relative pt-40 pb-20 px-8 flex flex-col items-center text-center overflow-hidden">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[400px] bg-[#b8c3ff]/5 blur-[120px] rounded-full pointer-events-none" />
        <div className="relative z-10 max-w-4xl">
          <div className="mb-8 flex justify-center">
            <img src="/logo.png" alt="Quintal AI" className="w-48 h-48 md:w-56 md:h-56 object-contain drop-shadow-[0_0_30px_rgba(42,63,149,0.4)]" />
          </div>
          <h1 className="font-sans text-5xl md:text-6xl font-bold mb-6 leading-tight bg-gradient-to-r from-[#b8c3ff] to-[#6d88ff] bg-clip-text text-transparent">
            Intelligence Delivered. Privately.
          </h1>
          <p className="text-lg text-[#c4c5d7] max-w-2xl mx-auto mb-12">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a href="#solutions" className="px-8 py-4 rounded-xl font-sans font-bold text-lg text-white hover:bg-white/10 transition-all border border-white/20" style={{ background: "rgba(16,19,26,0.7)" }}>
              Learn More
            </a>
          </div>
        </div>
      ...
      {/* Solutions Grid */}
      <section id="solutions" className="px-8 py-20 max-w-7xl mx-auto">
        <div className="mb-12">
          <h2 className="font-sans text-3xl md:text-4xl font-bold mb-4 text-white">Cognitive Solutions</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            <div key={card.title} className="p-8 rounded-2xl group hover:border-[#b8c3ff]/50 transition-all duration-500 hover:-translate-y-2" style={{ background: "rgba(16,19,26,0.7)", border: "1px solid rgba(255,255,255,0.1)" }}>
              <div className="mb-6 h-12 w-12 rounded-xl bg-[#b8c3ff]/10 flex items-center justify-center group-hover:bg-[#b8c3ff]/20 transition-colors">
                <div className="w-5 h-5 rounded-full bg-[#b8c3ff]/60" />
              </div>
              <h3 className="font-sans text-xl font-bold mb-3 text-white">{card.title}</h3>
      ...
      {/* Privacy Section */}
      <section id="privacy" className="px-8 py-20 max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="lg:w-1/2">
            <div className="mb-4 font-mono text-xs text-[#b8c3ff] tracking-[0.2em] uppercase">Security Protocol</div>
            <h2 className="font-sans text-3xl md:text-4xl font-bold mb-8 text-white">Privacy by Architecture</h2>
      ...
      <footer id="footer" className="border-t border-[#444655]/30 mt-20">
        <div className="max-w-7xl mx-auto px-8 py-16">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 border-t border-[#444655]/20 pt-6">
            <p className="font-mono text-[10px] text-[#8e90a0] uppercase tracking-widest">&copy; 2025 Quintal AI. Enterprise AI Platform.</p>
