            ...
            <div className="glass-panel rounded-xl w-full max-w-md p-6 space-y-4">
              ...
              {generatedLink && (
                <div className="flex items-center gap-2 p-3 bg-secondary/5 border border-secondary/20 rounded-lg">
                  ...
                  <input readOnly value={generatedLink} onClick={(e) => (e.target as HTMLInputElement).select()} className="flex-1 bg-transparent text-xs font-mono text-on-surface focus:outline-none" />
                </div>
              )}
            </div>
          </div>
